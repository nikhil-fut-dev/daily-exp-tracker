    ...
    >
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-slate-800 border border-slate-700 rounded-xl py-3 pl-12 pr-4 text-white focus:ring-2 focus:ring-indigo-500 outline-none"
            />
          </div>
        </div>
      ...
      <div className="mt-5">
        ...
        <textarea
          ...
          className="w-full bg-slate-800 border border-slate-700 rounded-xl p-4 text-white resize-none focus:ring-2 focus:ring-indigo-500 outline-none"
        />
      </div>
      ...
      <div className="mt-6">
        <button
          type="submit"
          className="w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 transition-all duration-300 px-8 py-3 rounded-xl text-white font-semibold"
        >
